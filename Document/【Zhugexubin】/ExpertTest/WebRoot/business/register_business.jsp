...
<script src="<%=basePath%>/js/regist_validate.js"></script>
</head>
...
<div data-role="page" id="page">
  ...
  <div data-role="content">
    <form id="myForm" method="post" action="<%=basePath %>/login/user_businessRegister.action">
      <div data-role="fieldcontain">
        <label for="busername">用户名:</label>
        <input type="text" name="business.busername" id="UserName" class="required" value="" placeholder="仅包括数字、字母或下划线" />
      </div>
      <div data-role="fieldcontain">
        <label for="bpwd">密码输入:</label>
        <input type="password" name="business.bpwd" id="Password" value="" placeholder="仅包括数字、字母或下划线" />
      </div>
      <div data-role="fieldcontain">
      ...
      <div data-role="fieldcontain">
        ...
        <input type="text" name="business.bname" id="CompanyName" value=""  />
      </div>
      <div data-role="fieldcontain">
        <label for="bnet">企业域名:</label>
        <input type="text" name="business.bnet" id="CompanySite" value=""  />
      </div>
      <div data-role="fieldcontain">
        <label for="bnet">企业电话:</label>
        <input type="text" name="business.btel" id="CompanyTel" value=""  />
      </div>
      <div data-role="fieldcontain">
        <label for="BusinessSelect" class="select">所属行业:</label>
        <select name="business.bvocation" id="BusinessSelect">
      ...
      <div data-role="fieldcontain">
        ...
        <textarea cols="40" rows="8" name="business.bsummary" id="CompanyIntroduction" placeholder="至少15个字"></textarea>
      </div>
