...
<body>
	<div data-role="page" style="background-color:#E6E6E6" id="page1">
    	<form method="post" action="<%=basePath%>business/business_modifyPwd.action">
			<div class="header">
            ...
            <div class="center_body">
            	...
            	<div class="label">
        			...
        			<input data-role="none" class="text_box" name="username" type="text" readonly value="<s:property value="#session.busername" />" />
         		</div>
                ...
                <div class="btn_red">
    				<button data-role="none" id="submit" type="submit"  class="btn_word">保存</button>
    			</div>
	...
	$("#submit").click(function(e) {
   	...
   	$.post("<%=basePath%>business/business_modifyPwd.action",info,function(data,status){
     		alert(data);
