    ...
    <div class="imformation" user_id="${business.bid }" project_id="${project.pid }">
  		<div class="project-item" data-id="???">  
            <div class="project-body">
        		<div class="project-rejectedtip">很抱歉，此次申请已被企业回绝，请关注其他项目，谢谢.</div>
            ...
            <div class="btn_blue">
  				<button id="return" class="btn_word" data-role="none">返回项目</button>
  			</div>
		</div>
...
<script type="text/javascript">
	$("#return").click(function(e) {
		...
		alert(user_id);
		alert(project_id);
		window.location.href = "<%=basePath%>XXXXX?userid="+user_id+"&projectid="+project_id;
    });
