...
<div data-role="page" id="basicinfo_expert">
	<div class="header">
		<h1 class="title_nobtn">专家注册</h1>
	</div>
    
    <div data-role="content">
		<form method="post" action="<%=basePath%>login/user_expertRegister.action">
			<div class="label">
        		<label data-role="none" class="label_tip" for="UserName">
                <div class="label_font">用户名&nbsp;:&nbsp;</div>
                </label>
        		<input data-role="none" class="text_box" type="text" name="expert.eusername" id="UserName" value="" placeholder="&nbsp&nbsp输入用户名" />
            </div>      	      
            <div class="label">
        		<label data-role="none" class="label_tip" for="Password">
                <div class="label_font">密码&nbsp;:&nbsp;</div>
                </label>
        		<input data-role="none" class="text_box" type="password" name="expert.epwd" id="Password" value="" placeholder="&nbsp&nbsp输入密码" />
      		</div>
            <div class="label">
            ...
            <div class="label">
       		 	<label data-role="none" class="label_tip" for="Name">
                <div class="label_font">真实姓名&nbsp;:&nbsp;</div>
                </label>
      		  	<input data-role="none" class="text_box" type="text" name="expert.name" id="Name" value="" />
      		</div>
            <div class="label">
        		<label data-role="none" class="label_tip" for="PhoneNumber">
                <div class="label_font">手机号码&nbsp;:&nbsp;</div>
                </label>
        		<input data-role="none" class="text_box" type="number" name="expert.phone" id="PhoneNumber" value="" />
      		</div>
            <div class="label">
        		<label data-role="none" class="label_tip" for="BusinessSelect">
            ...
            <div class="label">
        		<label data-role="none" class="label_tip" for="JobSelect">
                <div class="label_font">专长领域&nbsp;:&nbsp;</div>
                </label>
            ...
            <div class="label">
        		<label data-role="none" class="label_tip" for="Year">
                <div class="label_font">入行年数&nbsp;:&nbsp;</div>
                </label>
        		<input data-role="none" class="text_box" type="number" name="expert.eyears" id="Year" value="" placeholder="&nbsp;&nbsp;请输入0~100之间的数字" />
      		</div>
        ...
        <script type="text/javascript">		
			...
			$("#UserName").blur(function(e) {
				var name = $(this).val();
	            $.post("<%=basePath%>login/user_expertExist.action", {username:name},function(data,status) {
					alert(data);
			});
        });
	</script>
